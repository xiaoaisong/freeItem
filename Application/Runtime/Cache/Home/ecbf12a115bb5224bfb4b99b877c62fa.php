...
<div class="right_chanpin"><div class="tittle"> </div>
    ...
    <div class="right_con_chan">
        <div class="chanpin_xx"><img src="<?php echo ($vol["picture"]); ?>"></div>
        ...
        <div class="SS">
            ...
            <div class="bd">
                <div class="jieshao_xq">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><p><?php echo (htmlspecialchars_decode($vol["product"])); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
